...
import (
	...
	"github.com/SherzodAbdullajonov/service1/postpb"
	"google.golang.org/grpc"
	"google.golang.org/grpc/credentials/insecure"
)

func NewDataServiceClient(ctx context.Context, addr string) (client pb.DataServiceClient, close func() error, err error) {
	if addr == "" {
	...
	return pb.NewDataServiceClient(conn), conn.Close, nil
}
